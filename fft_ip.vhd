-- megafunction wizard: %FFT v12.1%
-- GENERATION: XML

-- ============================================================
-- Megafunction Name(s):
-- 			asj_fft_sglstream_fft_121
-- ============================================================
-- Generated by FFT 12.1 [Altera, IP Toolbench 1.3.0 Build 177]
-- ************************************************************
...
library fft_lib;
use fft_lib.fft_pack_fft_121.all;
...
ARCHITECTURE SYN OF fft_ip IS


	COMPONENT asj_fft_sglstream_fft_121
	GENERIC (
		nps	: NATURAL;
		bfp	: NATURAL;
		nume	: NATURAL;
...
-- Retrieval info: <MEGACORE title="FFT MegaCore Function"  version="12.1"  build="177"  iptb_version="1.3.0 Build 177"  format_version="120" >
-- Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.FFTModelClass"  active_core="asj_fft_sglstream_fft_121" >
...
-- Retrieval info:      <PRIVATE name = "filename" value="fft_ip_syn.v"  type="STRING"  enable="1" />
-- Retrieval info:     </NAMESPACE>
...
-- =========================================================
-- RELATED_FILES: fft_ip.vhd;
-- IPFS_FILES: fft_ip.vho;
-- =========================================================
